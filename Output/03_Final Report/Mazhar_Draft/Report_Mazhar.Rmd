...
```{r arima_deseas, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4, results='hide'}
...
```{r arima_fourier, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4, results='hide'}
K <- 3
...
#### TBATS
TBATS is designed for complex seasonal patterns using trigonometric terms, Box–Cox transformation, ARMA errors, and trend components. Despite this flexibility, residual diagnostics still showed autocorrelation at seasonal lags, so TBATS was not selected for final forecasting.

```{r tbats_model, include=FALSE}
...
```{r nn_model, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4, results='hide'}
K <- 3
xreg_train <- fourier(ts_train, K=K)
...
```{r sses_model, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4, results='hide'}
