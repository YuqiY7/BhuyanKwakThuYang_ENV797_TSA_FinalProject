...
```{r Selecting Best Models, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="US Cleaned: Forecast Comparison Across Models"}
# Create Tables 
kbl(tpscoresUSout, 
...
### Forecast for 2025 with Best Three Models (US Cleaned) 
...
```{r forecast result 2025 US outlier, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="US Cleaned: Forecast Unemployment Rate for 2025 — Top 3 Models"}
